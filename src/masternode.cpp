...
{
    if (nHeight >  1500000) return     250000 * COIN;
    if (nHeight >  1300000) return     225000 * COIN;
    if (nHeight >  1100000) return     200000 * COIN;
    if (nHeight >  900000)  return     175000 * COIN;
    if (nHeight >  700000)  return     150000 * COIN;
    if (nHeight >  500000)  return     125000 * COIN;
    if (nHeight >  300000)  return     100000 * COIN;
    if (nHeight >  100000)  return     75000 * COIN;
    if (nHeight >  900)     return     50000 * COIN;
...
{
    if (nHeight >   900) return GetBlockValue(nHeight) * 60 / 100;
