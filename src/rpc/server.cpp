...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTAD features */
        {"bitcoinadult", "listmasternodes", &listmasternodes, true },
        {"bitcoinadult", "getmasternodecount", &getmasternodecount, true },
        {"bitcoinadult", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"bitcoinadult", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"bitcoinadult", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"bitcoinadult", "masternodecurrent", &masternodecurrent, true },
        {"bitcoinadult", "startmasternode", &startmasternode, true },
        {"bitcoinadult", "createmasternodekey", &createmasternodekey, true },
        {"bitcoinadult", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"bitcoinadult", "listmasternodeconf", &listmasternodeconf, true },
        {"bitcoinadult", "getmasternodestatus", &getmasternodestatus, true },
        {"bitcoinadult", "getmasternodewinners", &getmasternodewinners, true },
        {"bitcoinadult", "getmasternodescores", &getmasternodescores, true },
        {"bitcoinadult", "preparebudget", &preparebudget, true },
        {"bitcoinadult", "submitbudget", &submitbudget, true },
        {"bitcoinadult", "mnbudgetvote", &mnbudgetvote, true },
        {"bitcoinadult", "getbudgetvotes", &getbudgetvotes, true },
        {"bitcoinadult", "getnextsuperblock", &getnextsuperblock, true },
        {"bitcoinadult", "getbudgetprojection", &getbudgetprojection, true },
        {"bitcoinadult", "getbudgetinfo", &getbudgetinfo, true },
        {"bitcoinadult", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"bitcoinadult", "mnfinalbudget", &mnfinalbudget, true },
        {"bitcoinadult", "checkbudgets", &checkbudgets, true },
        {"bitcoinadult", "mnsync", &mnsync, true },
        {"bitcoinadult", "spork", &spork, true },
