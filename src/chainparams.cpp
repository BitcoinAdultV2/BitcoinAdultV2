...
// Copyright (c) 2021 The Bitcoin Adult Core Developers
...
*/
        ...
        // spork keys
        consensus.strSporkPubKey = "037b6b4b0b8d539645702f977f42c1cdc2301da4ba9f9dd6445e8043916653a9b5";
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "45.32.146.114"));
        vSeeds.push_back(CDNSSeedData("tseed1", "65.20.100.205"));
        vSeeds.push_back(CDNSSeedData("tseed2", "45.63.89.192"));
        vSeeds.push_back(CDNSSeedData("seed3", "207.180.240.69"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // bitcoinadult starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseed3", "tseed3.bitcoinadult.eu"));
        vSeeds.push_back(CDNSSeedData("tseed4", "tseed4.bitcoinadult.eu"));
        vSeeds.push_back(CDNSSeedData("tseed5", "tseed5.bitcoinadult.eu"));
        vSeeds.push_back(CDNSSeedData("tseed6", "tseed6.bitcoinadult.eu"));
        vSeeds.push_back(CDNSSeedData("tseed7", "tseed7.bitcoinadult.eu"));
        vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.bitcoinadult.eu"));
