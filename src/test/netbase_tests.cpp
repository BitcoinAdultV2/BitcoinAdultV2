...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:36552", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:36552", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:36552", "::ffff:127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[::]:36552", "::", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("::36552", "::36552", -1));
    BOOST_CHECK(TestSplitHost(":36552", "", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[]:36552", "", __PORT_MAINNET__));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:36552", "127.0.0.1:36552"));
