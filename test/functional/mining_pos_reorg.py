...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected BTAD and zBTAD supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zBTADsupply']:
                assert_equal(node['zBTADsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check BTAD and zBTAD supply at the beginning
        # ------------------------------------------
        # zBTAD supply: 2 coins for each denomination
        ...
        # BTAD supply: block rewards minus burned fees for minting
        ...
        # Verify that BTAD and zBTAD supplies were properly updated after the spends and reorgs
        self.log.info("Check BTAD and zBTAD supply...")
