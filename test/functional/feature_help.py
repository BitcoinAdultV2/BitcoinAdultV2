...
"""Verify that starting bitcoinadult with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinadult with -? for help text")
        ...
        self.log.info("Start bitcoinadult with -version for version information")
