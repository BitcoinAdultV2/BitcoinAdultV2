...
* Fill in the following data:
    * Application Name: `BitcoinAdult Core`
    * Application Version: `1.2.0.0`
    * Application Publisher: `2020 BitcoinAdult Core Developers`
    * Application Website: `https://bitcoinadult.ey/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `BitcoinAdult`
