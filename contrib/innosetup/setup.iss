...
#define MyAppName "Bitcoinadult Core"
#define MyAppPublisher "2021 DECENOMY Core Developers"
#define MyAppURL "https://bitcoinadult.eu/"
#define MyAppExeName "bitcoinadult-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/BTAD/bootstrap.zip"
...
DefaultDirName={autopf}\Bitcoinadult
...
OutputDir=.\output
OutputBaseFilename=BitcoinadultSetup
...
DefaultGroupName=Bitcoinadult Core
...
[Files]
Source: ".\package\bitcoinadult-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Bitcoinadult\Bitcoinadult-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Bitcoinadult\Bitcoinadult-Qt,strDataDir|{userappdata}\Bitcoinadult\}');
  Result := True;
end;
